...
/**
 * JiraClientIssueNotificationSchemesApi
 *
...
public interface JiraClientIssueNotificationSchemesApi {
    ...
    * **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
    ...
    void delete2NotificationschemeByNotificationSchemeIdv1(
            @NotNull @Param("notificationSchemeId") String notificationSchemeId
    );
    ...
    * **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
    ...
    void delete2NotificationschemeByNotificationSchemeIdnotificationByNotificationIdv1(
            @NotNull @Param("notificationSchemeId") String notificationSchemeId,
            @NotNull @Param("notificationId") String notificationId
    );
