...
/**
 * JiraClientIssueSecuritySchemeConsumerApi
 *
...
public class JiraClientIssueSecuritySchemeConsumerApi {
    private final JiraClientIssueSecuritySchemeApi api;

    public JiraClientIssueSecuritySchemeConsumerApi(JiraClientIssueSecuritySchemeApi api) {
        this.api = api;
    }
