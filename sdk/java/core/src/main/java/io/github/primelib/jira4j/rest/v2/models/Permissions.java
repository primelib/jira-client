...
public class Permissions {
    ...
    protected PermissionsPermissions permissions;
     ...
     */
    @ApiStatus.Internal
    public Permissions(PermissionsPermissions permissions) {
     ...
     * @return permissions
     */
    public PermissionsPermissions permissions() {
     ...
     * @return this
     */
    public Permissions permissions(PermissionsPermissions permissions) {
        this.permissions = permissions;
        return this;
    }
     ...
     */
    @JsonProperty("permissions")
    public PermissionsPermissions getPermissions() {
        return this.permissions;
    }
     ...
     * @param permissions permissions
     */
    public void setPermissions(PermissionsPermissions permissions) {
        this.permissions = permissions;
    }
