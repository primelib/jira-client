...
public class ProjectRoleDetails {
     ...
     */
    @ApiStatus.Internal
    public ProjectRoleDetails(Boolean admin, Boolean defaultProp, String description, Long id, String name, Boolean roleConfigurable, Object scope, String self, String translatedName) {
        this.admin = admin;
