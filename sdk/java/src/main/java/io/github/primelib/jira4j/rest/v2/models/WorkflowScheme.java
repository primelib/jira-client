...
Defaults to `false`.
     */
    @ApiStatus.Internal
    public WorkflowScheme(String defaultWorkflow, String description, Boolean draft, Long id, Map<String, String> issueTypeMappings, IssueTypes issueTypes, String lastModified, Object lastModifiedUser, String name, String originalDefaultWorkflow, Map<String, String> originalIssueTypeMappings, String self, Boolean updateDraftIfNeeded) {
     ...
     * @return this
     */
    public WorkflowScheme issueTypes(IssueTypes issueTypes) {
        this.issueTypes = issueTypes;
        return this;
    }
