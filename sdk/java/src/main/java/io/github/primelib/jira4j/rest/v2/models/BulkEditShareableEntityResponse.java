...
public class BulkEditShareableEntityResponse {
    ...
    protected EntityErrors entityErrors;
     ...
     */
    @ApiStatus.Internal
    public BulkEditShareableEntityResponse(String action, EntityErrors entityErrors) {
        this.action = action;
     ...
     * @return entityErrors
     */
    public EntityErrors entityErrors() {
     ...
     * @return this
     */
    public BulkEditShareableEntityResponse entityErrors(EntityErrors entityErrors) {
        this.entityErrors = entityErrors;
        return this;
    }
     ...
     * @param entityErrors entityErrors
     */
    public void setEntityErrors(EntityErrors entityErrors) {
        this.entityErrors = entityErrors;
    }
