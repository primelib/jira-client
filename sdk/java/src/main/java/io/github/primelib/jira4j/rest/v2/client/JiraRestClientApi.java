...
public interface JiraRestClientApi {
    ...
    */
    @RequestLine("GET /rest/api/2/user/nav4-opt-property/{propertyKey}?accountId={accountId}")
    @Headers({
        "Accept: application/json"
    })
    UserNavPropertyJsonBean get2UserNav4OptPropertyByPropertyKeyV1(
            @Nullable @Param("accountId") String accountId,
            @NonNull @Param("propertyKey") String propertyKey
    );
    ...
    * @param payload The value of the property. The value has to be a boolean [JSON](https://tools.ietf.org/html/rfc4627) value. The maximum length of the property value is 32768 bytes.
    */
    @RequestLine("PUT /rest/api/2/user/nav4-opt-property/{propertyKey}?accountId={accountId}")
    @Headers({
        "Content-Type: application/json",
        "Accept: application/json"
    })
    Object put2UserNav4OptPropertyByPropertyKeyV1(
            @Nullable @Param("accountId") String accountId,
            @NonNull @Param("propertyKey") String propertyKey,
            @NonNull Object payload
    );
