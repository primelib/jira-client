...
/**
 * JiraRestClientIssueSecuritySchemeConsumerApi
 *
...
public class JiraRestClientIssueSecuritySchemeConsumerApi {
    private final JiraRestClientIssueSecuritySchemeApi api;

    public JiraRestClientIssueSecuritySchemeConsumerApi(JiraRestClientIssueSecuritySchemeApi api) {
        this.api = api;
    }
